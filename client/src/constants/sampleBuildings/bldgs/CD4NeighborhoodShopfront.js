...
export default {
				...
				physicalInfo : {
								buildingName: "CD4 Neighborhood Shopfront",
								siteLocation: "San Marocs, TX",
								buildingHeight: 3,
								siteArea: 6000,
								siteNetToGross: 1,
								landscapingPerc: 0.19619377162629764,
								underbuildPerc: 0.7,
								residentialType: "Multifamily",
								occupancyType: "Renter",
								residentialUsePerc: 0.5,
								retailUsePerc: 0.5,
								officeUsePerc: 0,
								industrialUsePerc: 0,
								publicUsePerc: 0,
				...
				basicFinInfo : {
								residentialConCosts: 80,
								retailConCosts: 80,
								officeConCosts: 80,
								industrialConCosts: 80,
								publicConCosts: 0,
								educationConCosts: 0,
								hotelConCosts: 0,
								parkingConCosts: 0,
