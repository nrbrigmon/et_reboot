    ...
    return (
      <div>
        ...
        <div className={classes.container}>
          <Wrapper900>
            <Route
              path={`/dev-types/building-mix`}
              render={() => <BuildingMixSection {...this.props} />}
            />
            <Route
              path={`/dev-types/attributes`}
              render={() => <AttributeSection {...this.props} />}
            />
            <Route
              path={`/dev-types/review`}
              render={() => <DevelopmentTypeReview {...this.props} />}
            />
            {pathHome ? <p>welcome home</p> : <span />}
            <div className={classes.cardAction}>
              ...
              <LoadWorkbookModal {...rest} />
              <SaveWorkbookModal {...rest} />
              <UpdateToast {...rest} />
            </div>
          </Wrapper900>
          <Footer />
