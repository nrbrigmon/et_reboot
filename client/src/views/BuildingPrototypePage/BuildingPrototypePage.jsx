...
import PhysicalFormComponent from 'ccomponents/create/buildings/PhysicalFormComponent';
import BasicFinFormComponent from 'ccomponents/create/buildings/BasicFinFormComponent';
import AdvancedFinFormComponent from 'ccomponents/create/buildings/AdvancedFinFormComponent';
import BuildingFormReviewComponent from 'ccomponents/create/buildings/BuildingFormReviewComponent';
import BuildingMenu from 'ccomponents/create/buildings/menu/BuildingMenu';
import LoadTemplateBldgModal from 'ccomponents/modals/LoadTemplateBldgModal';
