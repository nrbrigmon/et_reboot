...
export const getPopulation = (
  ...
  let newPopulationObj = devTypes.map(function(currentDevType) {
    ...
    let newPop =
      currentDevType.totalAcre *
      getSumProduct(bldgHHAcre, devPercMix) *
      (1 - publicRoadsPerc - civicPerc - openSpacePerc) *
      (getSumProduct(bldgHHSize, bldgHHAcre, devPercMix) /
        getSumProduct(bldgHHAcre, devPercMix));
    // console.log(newPop);
...
export const getJobCounts = (
  ...
  let newMetricObj = devTypes.map(function(currentDevType) {
    ...
    let newJobs =
      currentDevType.totalAcre *
      getSumProduct(jobsPerAcre, devPercMix) *
      (1 - publicRoadsPerc - civicPerc - openSpacePerc);
    // ( getSumProduct(bldgHHSize,bldgHHAcre,devPercMix) / getSumProduct(bldgHHAcre,devPercMix) );
    // console.log(newJobs);
