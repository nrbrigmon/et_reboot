    ...
    series: [
      {
        ...
        data: [
          ...
          {
            name:
              data.rParkingSf === 0 && data.rInternalStructureParkingSf === 0
                ? null
                : "Parking",
            y:
              data.rParkingSf === 0 && data.rInternalStructureParkingSf === 0
                ? null
                : data.rParkingSf + data.rInternalStructureParkingSf
          }
        ]
      }
    ]
    ...
    return (
      <Grid container className="myTables">
        <Grid item xs={12} className={classes.paper}>
          <h4>
            {bldg.rBuildingName} | {bldg.rLotLocation}
          </h4>
        </Grid>
        ...
        <Grid item xs={6}>
          <div>
            ...
            <ReactHighcharts
              config={chartConfig(bldg, "Building Sq Ft Mix (%)")}
            />
          </div>
        </Grid>
          ...
          <Table>
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rResidentialSfMix * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                  />{" "}
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rIndustrialSfMix * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                  />{" "}
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rEducationalSfMix * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                  />{" "}
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rInternalParkingSfMix * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                  />{" "}
                </TableCell>
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rResidentialNetUnit || 0}
                    suffix=""
                    displayType={"text"}
                    decimalScale={0}
                  />{" "}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rResidentialGrossUnit || 0}
                    suffix=""
                    displayType={"text"}
                    decimalScale={0}
                  />{" "}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rResidentialDwellUnit || 0}
                    suffix=""
                    displayType={"text"}
                    decimalScale={2}
                  />{" "}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHouseholdRenterPerc * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                    decimalScale={0}
                  />{" "}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHouseholdOwnerPerc * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                    decimalScale={0}
                  />{" "}
          ...
          <Table>
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHouseholdAffordPerc * 100 || 0}
                    suffix="%"
                    displayType={"text"}
                  />{" "}
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHouseholdEstIncome || 0}
                    suffix=""
                    prefix="$"
                    thousandSeparator={true}
                    displayType={"text"}
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rRetailSpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rOfficeSpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rIndustrialSpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rPublicSpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rEducationSpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHospitalitySpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rParkingSpacePerEmp || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rIndustrialEmpPerSf || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rEducationEmpPerSf || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHospitalityEmpPerSf || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rIndustrialLeaseRate || 0}
                    prefix="$"
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rEducationLeaseRate || 0}
                    prefix="$"
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHospitalityRateNight || 0}
                    prefix="$"
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHospitalityNetPerRoom || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHospitalityGrossPerRoom || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rHospitalityRoomsPerSf || 0}
                    prefix=""
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
          ...
          <Table>
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rPropTaxRevenueYr || 0}
                    prefix="$"
                    suffix=""
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rRateOfReturn * 100 || 0}
                    prefix=""
                    suffix="%"
                    displayType={"text"}
                    thousandSeparator={true}
              ...
              <TableRow>
                ...
                <TableCell>
                  <NumberFormat
                    value={bldg.rProjectReturn * 100 || 0}
                    prefix=""
                    suffix="%"
                    displayType={"text"}
                    thousandSeparator={true}
