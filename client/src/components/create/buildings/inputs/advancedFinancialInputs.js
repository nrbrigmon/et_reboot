...
// Financial Targets
				...
				debServRatioRetail
				debServRatioOffice
				debServRatioIndustrial
				debServRatioHotel
				debServRatioParking
				// IRR on Public Participation
				iRRParticipationRenter
				iRRParticipationRetail
				iRRParticipationOffice
				iRRParticipationIndustrial
				iRRParticipationHotel
				iRRParticipationParking

				projectReturnRateOwner
                returnToEquityOwner
