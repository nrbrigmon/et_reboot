...
export const addLayerToMap = (ctx) => {
	...
	if (!_dev_name || _dev_name === undefined){
		return;
...
export const OSM_Map = L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'})
