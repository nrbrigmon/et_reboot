			...
			<Wrapper900>
				<Grid item sm={12} md={6} >
					...
					<iframe id="old_way"
						...
						<p>I created this video back in 2014 to show the potential for scenario planning with 3D modelling. Note the three different types of proprietary Desktop software and the large array of spreadsheets. This planted the seed for a more streamlined approach.</p>
				</Grid>
				<Grid item sm={12} md={6} >
					<h2>{_constants.APP_NAME}</h2>
					<p>The ambition of this application is to globally centralize the data and the functionality of this planning tool. All the thinking in one space.</p> 
