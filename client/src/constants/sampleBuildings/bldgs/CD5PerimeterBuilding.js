...
export default {
				...
				physicalInfo : {
								buildingName: "CD5 Perimeter Building",
								siteLocation: "San Marcos, TX",
								buildingHeight: 5,
								siteArea: 22000,
								siteNetToGross: 0.9,
								landscapingPerc: 0.203491706735936,
								underbuildPerc: 0.6,
								residentialType: "Multifamily",
								occupancyType: "Renter",
								residentialUsePerc: 0.8,
								retailUsePerc: 0.2,
								officeUsePerc: 0,
								industrialUsePerc: 0,
								publicUsePerc: 0,
								...
								retailAreaPerEmp: 400,
								officeAreaPerEmp: 250,
								industrialAreaPerEmp: 1000,
								publicAreaPerEmp: 400,
								educationAreaPerEmp: 500,
								hotelAreaPerEmp: 1000,
								hotelAreaPerRoom: 600,
								parkingAreaPerEmp: 0,
								residentialParkPerUnit: 1.85,
								retailParkPerArea: 2.5,
								officeParkPerArea: 4,
								...
								internalParkingLvls: 1.0000000000000004,
				...
				basicFinInfo : {
								residentialConCosts: 120,
								retailConCosts: 120,
								officeConCosts: 120,
								industrialConCosts: 70,
								publicConCosts: 70,
								educationConCosts: 70,
								hotelConCosts: 70,
								parkingConCosts: 20000,
								landImpCostsPerSf: 5,
								testSubsidy: 0,
								monthlyRentPerSf: 2,
								monthlyParkingCost: 0,
								salesPricePerSf: 200,
								commercialRetailRentSf: 25,
								commercialOfficeRentSf: 25,
								commercialIndustrialRentSf: 10,
								commercialPublicRentSf: 25,
								commercialEducationRentSf: 25,
